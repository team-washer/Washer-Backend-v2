    ...
    class Describe_getUsersByFilter {
        ...
        class Context_with_name_filter {
            ...
            void it_returns_users_by_name() {
                ...
                given(userRepository.findByNameContaining(searchName)).willReturn(users);
                // When
                ...
                then(userRepository).should(times(1)).findByNameContaining(searchName);
                then(userRepository).should(never()).findByRoomNumber(anyString());
            }
        }
        @Nested
        ...
        class Context_with_room_number_filter {
            ...
            void it_returns_users_by_room_number() {
                ...
                given(userRepository.findByRoomNumber(roomNumber)).willReturn(users);
                // When
                ...
                then(userRepository).should(times(1)).findByRoomNumber(roomNumber);
            }
        }
        @Nested
        ...
        class Context_with_grade_and_floor_filter {
            ...
            void it_returns_users_by_grade_and_floor() {
                ...
                List<User> users = Arrays.asList(user1, user2);
                given(userRepository.findByFloorAndGrade(floor, grade)).willReturn(users);
                // When
                ...
                then(userRepository).should(times(1)).findByFloorAndGrade(floor, grade);
            }
        }
        @Nested
        ...
        class Context_with_grade_only_filter {
            ...
            void it_returns_users_by_grade() {
                ...
                List<User> users = List.of(user);
                given(userRepository.findByGrade(grade)).willReturn(users);
                // When
                ...
                then(userRepository).should(times(1)).findByGrade(grade);
            }
        }
        @Nested
        ...
        class Context_with_floor_only_filter {
            ...
            void it_returns_users_by_floor() {
                ...
                List<User> users = List.of(user);
                given(userRepository.findByFloor(floor)).willReturn(users);
                // When
                ...
                then(userRepository).should(times(1)).findByFloor(floor);
            }
        }
        @Nested
