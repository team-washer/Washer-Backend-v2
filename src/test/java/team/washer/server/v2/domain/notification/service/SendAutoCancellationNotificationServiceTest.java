...
import team.washer.server.v2.domain.notification.service.impl.SendAutoCancellationNotificationServiceImpl;
import team.washer.server.v2.domain.user.entity.User;

@ExtendWith(MockitoExtension.class)
class SendAutoCancellationNotificationServiceTest {

    @InjectMocks
    private SendAutoCancellationNotificationServiceImpl sendAutoCancellationNotificationService;
    ...
    @Nested
    @DisplayName("예약 자동 취소 알림 전송")
    class ExecuteTest {

        @Test
        @DisplayName("예약 자동 취소 알림을 DB에 저장하고 FCM으로 전송한다")
