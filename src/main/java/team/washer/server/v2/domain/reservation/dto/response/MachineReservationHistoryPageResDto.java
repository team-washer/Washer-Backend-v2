...
@Schema(description = "기기별 예약 히스토리 페이지 응답 DTO")
public record MachineReservationHistoryPageResDto(
        @Schema(description = "예약 히스토리 목록") List<MachineReservationHistoryResDto> content,
