...
@ApiResponses({
        ...
        @ApiResponse(responseCode = "409", description = "현재 상태와 충돌하는 요청", content = @Content(schema = @Schema(implementation = CommonErrorResponseResDto.class))),
        ...
        @ApiResponse(responseCode = "503", description = "Redis 또는 외부 서비스 일시 장애", content = @Content(schema = @Schema(implementation = CommonErrorResponseResDto.class)))})
